...
namespace DaemonPieShop.Data.DbContexts
{
    public class DaemonPieShopDbContext : IdentityDbContext<IdentityUser>
    {
        public DaemonPieShopDbContext(DbContextOptions<DaemonPieShopDbContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 1, CategoryName = "Fruit Pie", Description = "All Fruits" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 2, CategoryName = "Cheese Cakes", Description = "Cheesy all the way" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId= 3 , CategoryName = "Seasonal Pies", Description = "Get in mood for a seasonal pie" });
        }
